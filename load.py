...
loan_path = "/Users/shonts/Documents/kaggle/loan.csv"
...
# issue_d is a date string like Mar-12. Parse as pandas DateTime
loan_36['issue_dt'] = pd.to_datetime(df['date'], format='%b-%y')

# filter to loans with complete history.
# note that Charged Off or Prepayed loans may have less that 36 months of history.
loan_36_ret = loan[loan_36.loan_status.isin(['Fully Paid', 'Charged Off', 'Default'])]
...
loan_36_ret['total_return'] = loan_36_ret[(loan_36_ret['total_pymnt_inv'] - loan_36_ret['funded_amnt_inv'])]
